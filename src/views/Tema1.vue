  ...
  .curso-main-container.pb-3.tema1
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .row.justify-content-center.align-items-center.mb-5.fondoverde(data-aos="fade-left").p-4
        ...
        .col-lg-8
          p El #[em endomarketing] entonces, se puede definir como un conjunto de estrategias y tácticas que se desarrollan al interior de la empresa, con el fin de promover la marca y los productos de esta, entre los empleados y colaboradores, generando sentido de pertenencia y mayor efectividad en el proceso de comercialización y promoción de los productos y servicios. 
          p En el artículo de la revista Dinero del 25 de marzo de 2017, se menciona el #[em endomarketing] como una estrategia que es partícipe del mercadeo holístico de la organización y se hace referencia a que esta estrategia es originada en las empresas de servicios Sasser y Arbeit (1976) manifiestan que “el personal es el primer mercado de una empresa de servicios”. Berry (1981), sostiene que “el alcance del mercadeo tradicionalmente se ha restringido a las transacciones que tienen lugar entre clientes y empresas” pero que “también es aplicable a los intercambios que se dan entre el personal y estas mismas organizaciones”, y por lo tanto se puede considerar a los empleados como clientes. 
